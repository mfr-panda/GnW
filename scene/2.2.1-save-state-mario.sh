...
dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.1-save-state-mario.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
...
Sélectionnez l'option souhaitée avec les flèche:" 0 0 0 \
          1 "1MB $consola solo Retro-Go: Effectuer un backup des états de sauvegarde existants qui se trouvent dans G&W" \
          2 "1MB $consola solo Retro-Go: Restaurer les états de sauvegarde du PC vers le G&W" \
          3 "1MB $consola solo Retro-Go: Supprimez les états de sauvegarde existants dans G&W pour le laisser propre" \
          ...
          9 "64MB $consola solo Retro-Go: Supprimez les états de sauvegarde existants dans G&W" \
...
case $menuitem in
  ...
  7)clear
    ...
    if [ $ans -eq 0 ]; then
        ...
        dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.1-save-state-mario.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
               --title "INFO: Utilisateur=$usuario --- Console sélectionnée=$consola --- Save states in:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" \
               --msgbox "Processus effectué. Etats sauvegardés dans:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" 0 0
    else
        dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.1-save-state-mario.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
               --title "INFO: Utilisateur=$usuario --- Console sélectionnée=$consola --- Save states in:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" \
               --msgbox "Processus annulé." 0 0
