...
dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.4-save-state-zelda.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
...
dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.4-save-state-zelda.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
       --title "INFO: Utilisateur=$usuario --- Console sélectionnée=$consola --- Save states en:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" \
       --ok-label Apply \
       --cancel-label Exit \
       --menu "
...
Sélectionnez l'option souhaitée avec les flèches:" 0 0 0 \
          1 "Sauvegardez les états de sauvegarde existants sur le G&W avec une puce de 64 Mo, 128Mo ou 256Mo" \
          2 "Restaurez les états de sauvegarde du PC vers le G&W avec une puce de 64 Mo, 128Mo ou 256Mo" \
          3 "Supprimez les états de sauvegarde existants sur le G&W avec une puce de 64 Mo, 128Mo ou 256Mo pour la laisser propre"   2>"${INPUT}"
menuitem=$(<"${INPUT}")
case $menuitem in
  1)clear
    dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.4-save-state-zelda.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
  ...
  2)clear
    ...
    if [ $ans -eq 0 ]; then
        ...
        dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.4-save-state-zelda.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
               --title "INFO: Utilisateur=$usuario --- Console sélectionnée=$consola --- Save states en:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" \
               --msgbox "Processus effectuué." 0 0
    else
        dialog --backtitle "G&W $consola - Utilitaires de flash ------------------ INFO: 2.2.4-save-state-zelda.sh Utilisateur = $usuario   ////   Console sélectionnée = $consola ------------------" \
               --title "INFO: Utilisateur=$usuario --- Console sélectionnée=$consola --- Save states en:/home/$usuario/gameandwatch/game-and-watch-retro-go/save_states/" \
               --msgbox "Processus annulé." 0 0
